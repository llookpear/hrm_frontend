...
import 'leave_request_status_provider.dart';
import 'package:loading_animation_widget/loading_animation_widget.dart';
import 'package:hrm_project/utils/format.dart';

class LeaveRequestStatusScreenWidget extends HookConsumerWidget {
  const LeaveRequestStatusScreenWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final leaveRequestProvider = ref.watch(leaveRequestStatusProvider);
    const String appBarTitle = 'Leave Status';
    const String text = "Status of leave requests created in current month";
            ...
            Expanded(
              child: Consumer(builder: (context, ref, child) {
                return leaveRequestProvider.when(
                  data: (data) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final formattedStartDate = convert.convertDateDdMmYyyy(leaveData.startDate);
                        final formattedEndDate = convert.convertDateDdMmYyyy(leaveData.endDate);
                  ...
                  error: (error, stackTrace) => Text('Error status: $error'),
                );
              }),
            ),
          ],
