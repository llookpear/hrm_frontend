...
import 'admin_edit_profile_provider.dart';

class EditAdminProfileScreenWidget extends HookConsumerWidget {
  final UserDetailModel userDetail;
  final String image;

  const EditAdminProfileScreenWidget(
